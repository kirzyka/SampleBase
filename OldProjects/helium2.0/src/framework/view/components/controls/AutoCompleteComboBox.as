...
package framework.view.components.controls
{
	...
	{
		/**
		 *  This property contain currest position of the cursor for 
		 *  IUITextField in the AutoCompleteComboBox.
		 *  
		 *  @default 0
		 */
		...
		/**
		 *  This propert contain state of removing highlight for item.
		 *  
		 *  @default false
		 */
		private var removeHighlight:Boolean = false;
		/**
		 *  This propert contain state of showing drop down list.
		 *  
		 *  @default false
		 */
