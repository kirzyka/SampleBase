package services.command.rates.bar
{
	...
	public class GetBarItemsInfoCommand extends BaseCommand
	{
		/**
		 *  @override
		 */
		...
		{
			_event = GetBarItemsInfoEvent(event);
			var delegate:BARDelegate = new BARDelegate(this);

			delegate.getBarItemsInfo(_event as GetBarItemsInfoEvent);
		...
		override public function result(data:Object):void
		{
			...
			var cells:ArrayCollection = model.ratesModule.barModule.cellsData;

			//model.barModule.cellsData= new ArrayCollection(new Array(35));
			...
			model.ratesModule.barModule.creationForm ++;
			super.result(data);
		}
