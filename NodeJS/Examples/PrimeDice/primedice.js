...
/**
 * Initialize a new `Primedice` with the given `accessapiKey`
 *
 * Example:
 *
 * ```js
...
Primedice.prototype.users = function() {
  ...
  var url = this._uri + 'users/'+userName+'?api_key=' + this._apiKey;
...
Primedice.prototype.deposit = function(callback) {
  ...
  var url = this._uri + 'deposit?api_key=' + this._apiKey;
...
Primedice.prototype.deposits = function(callback) {
  ...
  var url = this._uri + 'deposits?api_key=' + this._apiKey;
...
Primedice.prototype.withdraw = function(amount, address, callback) {
  ...
  var url = this._uri + 'withdraw?api_key=' + this._apiKey;
...
Primedice.prototype.withdrawals = function(callback) {
  ...
  var url = this._uri + 'withdrawals?api_key=' + this._apiKey;
...
Primedice.prototype.bet = function(amount, target, condition, callback) {
  ...
  var url = this._uri + 'bet?api_key=' + this._apiKey;
...
Primedice.prototype.seed = function(seed, callback){
  ...
  var url = this._uri + 'seed?api_key=' + this._apiKey;
...
Primedice.prototype.mybets = function(callback) {
  ...
  var url = this._uri + 'mybets?api_key=' + this._apiKey;
...
Primedice.prototype.bets = function(){
  ...
  if (arguments.length == 1) {
    url = this._uri + 'bets?api_key=' + this._apiKey;
    callback = arguments[0];
  }
  else {
    url = this._uri + 'bets/'+arguments[0]+'?api_key=' + this._apiKey;
    callback = arguments[1];
  }
...
Primedice.prototype.send = function() {
  ...
  var url = this._uri + 'send?api_key=' + this._apiKey;
...
Primedice.prototype.rooms = function(callback) {
  ...
  var url = this._uri + 'rooms?api_key=' + this._apiKey;
...
Primedice.prototype.messages = function() {
  ...
  var url = this._uri + 'messages?api_key=' + this._apiKey + room;
...
Primedice.prototype.allmessages = function(callback) {
  ...
  var url = this._uri + 'allmessages?api_key=' + this._apiKey;
