package com.db.rds.content.ExceptionManagement.view.controls 
{
	...
	public class ThreeStateCheckBox extends Button 
	{
		...
		private var swatch: ThreeStateCheckBoxSkin;
		...
		override protected function createChildren(): void {
			...
			upIcon = createSkin("upIcon", ThreeStateCheckBoxSkin);
			overIcon = createSkin("overIcon", ThreeStateCheckBoxSkin);
			downIcon = createSkin("downIcon", ThreeStateCheckBoxSkin);
			disabledIcon = createSkin("disabledIcon", ThreeStateCheckBoxSkin);
			selectedUpIcon = createSkin("selectedUpIcon", ThreeStateCheckBoxSkin);
			selectedOverIcon = createSkin("selectedOverIcon", ThreeStateCheckBoxSkin);
			selectedDownIcon = createSkin("selectedDownIcon", ThreeStateCheckBoxSkin);
			selectedDisabledIcon = createSkin("selectedDisabledIcon", ThreeStateCheckBoxSkin);
			middleUpIcon = createSkin("middleUpIcon", ThreeStateCheckBoxSkin);
			middleOverIcon = createSkin("middleOverIcon", ThreeStateCheckBoxSkin);
			middleDownIcon = createSkin("middleDownIcon", ThreeStateCheckBoxSkin);
			disabledMiddleIcon = createSkin("disabledMiddleIcon", ThreeStateCheckBoxSkin);
		}
		...
		public function setSelected(selected: Boolean, middle: Boolean): void {
			_selected = selected;
			_middle = middle;
			invalidateDisplayList();
			dispatchEvent(new FlexEvent(FlexEvent.VALUE_COMMIT));
